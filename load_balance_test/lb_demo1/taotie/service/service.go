...
import (
	"context"
	"example/load_balance_test/lb_demo1/common"
	idgen "example/load_balance_test/lb_demo1/generator/api"
	"example/load_balance_test/lb_demo1/naming"
	"example/load_balance_test/lb_demo1/taotie/config"
	"fmt"
