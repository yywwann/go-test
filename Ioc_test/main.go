...
func NewIntSet1() IntSet1 {
	return IntSet1{data: make(map[int]bool)}
}

func (set *IntSet1) Add(x int) {
	if !set.Contains(x) {
		set.data[x] = true
...
func (set *IntSet1) Undo() error {
	return set.undo.Undo()
}

func (set *IntSet1) Contains(x int) bool {
	return set.data[x]
}
